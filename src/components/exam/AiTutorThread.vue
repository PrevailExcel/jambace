      ...
      <div class="messages" ref="messagesEl">
        ...
        <div v-if="!threadStarted" class="empty-thread">
          ...
          <div v-if="offlineBlocked" class="offline-blocked">
            ...
            <p>You're offline right now. The explanation above is still available. Come back online to ask the AI Tutor
              questions.</p>
          </div>
          <template v-else>
            <div class="et-avatar">
              <PhRobot :size="22" weight="fill" />
            </div>
            <p class="et-text">Ask me anything about this question — I'll explain it differently, give examples, or
              break down the working step by step.</p>
...
const suggestions = computed(() => {
  console.log("The full context is", context.value)
...
.send-btn.active {
  background: var(--green);
  color: white;
  box-shadow: 0 3px 12px rgba(0, 200, 83, 0.4);
}
