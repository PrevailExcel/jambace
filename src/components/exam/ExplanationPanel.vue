  ...
  <Transition name="slide-up">
    <div v-if="visible" class="explanation-panel" :class="{ expanded: showTutor }">
      ...
      <div class="exp-tabs">
        ...
        <button
          class="exp-tab"
          :class="{ active: showTutor, locked: !userStore.isPremium }"
          @click="handleTutorTab"
        >
...
.explanation-panel.expanded { max-height: 82vh; }
.explanation-panel::-webkit-scrollbar { width: 3px; }
.explanation-panel::-webkit-scrollbar-thumb { background: rgba(255,255,255,0.1); border-radius: 3px; }
...
.exp-header-left { display: flex; align-items: center; gap: 8px; }
.exp-header-icon {
...
.exp-header-actions { display: flex; align-items: center; gap: 8px; }
...
.exp-close:hover { background: rgba(255,255,255,0.15); color: white; }
...
.exp-tab.active { background: white; color: var(--navy); }
.exp-tab.locked { opacity: 0.6; }
...
.exp-tab.active .tab-credit { background: var(--navy); color: white; }
...
.exp-correct-banner strong { font-weight: 700; }

/* ── CONTENT ── */
.exp-content { display: flex; flex-direction: column; gap: 14px; }
...
.exp-body.blurred { filter: blur(4px); user-select: none; pointer-events: none; }
.exp-body p { margin-bottom: 2px; }
.exp-blank  { height: 8px; }
...
.exp-locked strong { display: block; color: white; font-size: 15px; font-family: var(--font-display); margin-bottom: 8px; }
.exp-locked p { color: rgba(255,255,255,0.45); font-size: 13px; line-height: 1.6; margin-bottom: 16px; }
.exp-upgrade-btn {
...
.tutor-prompt-banner:hover { background: rgba(0,200,83,0.13); border-color: rgba(0,200,83,0.4); }
.tpb-left { display: flex; align-items: center; gap: 10px; }
.tpb-icon {
...
.tpb-left strong { display: block; color: white; font-size: 13px; }
.tpb-left span   { color: rgba(255,255,255,0.45); font-size: 11.5px; }
.tpb-arrow { color: rgba(255,255,255,0.4); }

/* ── TRANSITIONS ── */
.slide-up-enter-active { transition: all 0.34s cubic-bezier(0.34, 1.1, 0.64, 1); }
.slide-up-leave-active { transition: all 0.22s ease; }
.slide-up-enter-from   { transform: translateY(100%); }
.slide-up-leave-to     { transform: translateY(100%); opacity: 0; }

.tab-fade-enter-active { transition: all 0.22s ease; }
